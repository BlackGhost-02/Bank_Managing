...
namespace Bank_MNGMT {
    ...
    public partial class bank_dbDataSet10 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/bank_dbDataSet101.xsd";
        ...
        public partial class transactionsDataTable : global::System.Data.TypedTableBase<transactionsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public transactionsRow AddtransactionsRow(string Transaction_Type, int Amount, System.DateTime Transaction_Date, string cust_name) {
        ...
        public partial class transactionsRow : global::System.Data.DataRow {
            ...
            public string cust_name {
                get {
                    try {
                        return ((string)(this[this.tabletransactions.cust_nameColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'cust_name\' in table \'transactions\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletransactions.cust_nameColumn] = value;
                }
            }
            ...
            public bool Iscust_nameNull() {
                return this.IsNull(this.tabletransactions.cust_nameColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void Setcust_nameNull() {
                this[this.tabletransactions.cust_nameColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Bank_MNGMT.bank_dbDataSet10TableAdapters {
    ...
    public partial class transactionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[transactions] ([Transaction_Type], [Amount], [Transaction_Date], [cust_name]) VALUES (@Transaction_Type, @Amount, @Transaction_Date, @cust_name);
SELECT TID, Transaction_Type, Amount, Transaction_Date, cust_name FROM transactions WHERE (TID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[transactions] SET [Transaction_Type] = @Transaction_Type, [Amount] = @Amount, [Transaction_Date] = @Transaction_Date, [cust_name] = @cust_name WHERE (([TID] = @Original_TID) AND ((@IsNull_Transaction_Type = 1 AND [Transaction_Type] IS NULL) OR ([Transaction_Type] = @Original_Transaction_Type)) AND ((@IsNull_Amount = 1 AND [Amount] IS NULL) OR ([Amount] = @Original_Amount)) AND ((@IsNull_Transaction_Date = 1 AND [Transaction_Date] IS NULL) OR ([Transaction_Date] = @Original_Transaction_Date)) AND ((@IsNull_cust_name = 1 AND [cust_name] IS NULL) OR ([cust_name] = @Original_cust_name)));
SELECT TID, Transaction_Type, Amount, Transaction_Date, cust_name FROM transactions WHERE (TID = @TID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT TID, Transaction_Type, Amount, Transaction_Date, cust_name FROM dbo.transa" +
                "ctions";
        ...
        public virtual int Fill(bank_dbDataSet10.transactionsDataTable dataTable) {
        ...
        public virtual bank_dbDataSet10.transactionsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bank_dbDataSet10.transactionsDataTable dataTable = new bank_dbDataSet10.transactionsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bank_dbDataSet10.transactionsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_TID, string Original_Transaction_Type, global::System.Nullable<int> Original_Amount, global::System.Nullable<global::System.DateTime> Original_Transaction_Date, string Original_cust_name) {
        ...
        public virtual int Insert(string Transaction_Type, global::System.Nullable<int> Amount, global::System.Nullable<global::System.DateTime> Transaction_Date, string cust_name) {
        ...
        public virtual int Update(string Transaction_Type, global::System.Nullable<int> Amount, global::System.Nullable<global::System.DateTime> Transaction_Date, string cust_name, int Original_TID, string Original_Transaction_Type, global::System.Nullable<int> Original_Amount, global::System.Nullable<global::System.DateTime> Original_Transaction_Date, string Original_cust_name, int TID) {
            if ((Transaction_Type == null)) {
            ...
            if ((Original_Transaction_Type == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[6].Value = ((string)(Original_Transaction_Type));
            }
            if ((Original_Amount.HasValue == true)) {
            ...
            if ((Original_cust_name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_cust_name));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Transaction_Type, global::System.Nullable<int> Amount, global::System.Nullable<global::System.DateTime> Transaction_Date, string cust_name, int Original_TID, string Original_Transaction_Type, global::System.Nullable<int> Original_Amount, global::System.Nullable<global::System.DateTime> Original_Transaction_Date, string Original_cust_name) {
            return this.Update(Transaction_Type, Amount, Transaction_Date, cust_name, Original_TID, Original_Transaction_Type, Original_Amount, Original_Transaction_Date, Original_cust_name, Original_TID);
        }
    }
