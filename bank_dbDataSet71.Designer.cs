...
namespace Bank_MNGMT {
    ...
    public partial class bank_dbDataSet7 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/bank_dbDataSet71.xsd";
        ...
        public partial class employeesDataTable : global::System.Data.TypedTableBase<employeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public employeesRow AddemployeesRow(string name, string position, string salary) {
...
namespace Bank_MNGMT.bank_dbDataSet7TableAdapters {
    ...
    public partial class employeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[employees] WHERE (([eid] = @Original_eid) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_position = 1 AND [position] IS NULL) OR ([position] = @Original_position)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[employees] ([name], [position], [salary]) VALUES (@name, @posi" +
                "tion, @salary);\r\nSELECT eid, name, position, salary FROM employees WHERE (eid = " +
                "SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[employees] SET [name] = @name, [position] = @position, [salary] = @salary WHERE (([eid] = @Original_eid) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_position = 1 AND [position] IS NULL) OR ([position] = @Original_position)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)));
SELECT eid, name, position, salary FROM employees WHERE (eid = @eid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT eid, name, position, salary FROM dbo.employees";
        ...
        public virtual int Fill(bank_dbDataSet7.employeesDataTable dataTable) {
        ...
        public virtual bank_dbDataSet7.employeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bank_dbDataSet7.employeesDataTable dataTable = new bank_dbDataSet7.employeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bank_dbDataSet7.employeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_eid, string Original_name, string Original_position, string Original_salary) {
        ...
        public virtual int Insert(string name, string position, string salary) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string position, string salary, int Original_eid, string Original_name, string Original_position, string Original_salary, int eid) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string position, string salary, int Original_eid, string Original_name, string Original_position, string Original_salary) {
            return this.Update(name, position, salary, Original_eid, Original_name, Original_position, Original_salary, Original_eid);
        }
    }
